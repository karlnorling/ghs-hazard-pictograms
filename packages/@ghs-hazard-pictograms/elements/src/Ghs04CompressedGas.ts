...
export class Ghs04CompressedGas extends HTMLElement {
  static readonly tagName = 'ghs-ghs04-compressed-gas';
  static readonly observedAttributes = ['title', 'description', 'width', 'height', 'aria-label'];

  private readonly _uid = `ghs-ghs04-compressed-gas-${++_instances}`;
