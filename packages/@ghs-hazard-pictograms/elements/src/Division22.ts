...
const _Attrs = `xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103.5 103.2"`;
...
export class Division22 extends HTMLElement {
  static readonly tagName = 'ghs-division-2-2';
  static readonly observedAttributes = ['title', 'description', 'width', 'height', 'aria-label'];

  private readonly _uid = `ghs-division-2-2-${++_instances}`;
