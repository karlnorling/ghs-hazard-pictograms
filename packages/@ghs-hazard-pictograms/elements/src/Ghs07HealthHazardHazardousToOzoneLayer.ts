...
export class Ghs07HealthHazardHazardousToOzoneLayer extends HTMLElement {
  static readonly tagName = 'ghs-ghs07-health-hazard-hazardous-to-ozone-layer';
  static readonly observedAttributes = ['title', 'description', 'width', 'height', 'aria-label'];

  private readonly _uid = `ghs-ghs07-health-hazard-hazardous-to-ozone-layer-${++_instances}`;
