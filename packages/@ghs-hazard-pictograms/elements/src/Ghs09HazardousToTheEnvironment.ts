...
export class Ghs09HazardousToTheEnvironment extends HTMLElement {
  static readonly tagName = 'ghs-ghs09-hazardous-to-the-environment';
  static readonly observedAttributes = ['title', 'description', 'width', 'height', 'aria-label'];

  private readonly _uid = `ghs-ghs09-hazardous-to-the-environment-${++_instances}`;
