...
const _Attrs = `xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103.725 103.125"`;
...
export class Division15 extends HTMLElement {
  static readonly tagName = 'ghs-division-1-5';
  static readonly observedAttributes = ['title', 'description', 'width', 'height', 'aria-label'];

  private readonly _uid = `ghs-division-1-5-${++_instances}`;
