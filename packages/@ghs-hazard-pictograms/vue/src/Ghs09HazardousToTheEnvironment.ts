...
export const Ghs09HazardousToTheEnvironment = defineComponent({
  name: 'Ghs09HazardousToTheEnvironment',
  inheritAttrs: false,
  props: {
    ...pictogramProps,
  },
  setup(props, { attrs }) {
    const uid = `ghs-ghs09-hazardous-to-the-environment-${++_instances}`;
    return () => {
