...
export const Ghs07HealthHazardHazardousToOzoneLayer = defineComponent({
  name: 'Ghs07HealthHazardHazardousToOzoneLayer',
  inheritAttrs: false,
  props: {
    ...pictogramProps,
  },
  setup(props, { attrs }) {
    const uid = `ghs-ghs07-health-hazard-hazardous-to-ozone-layer-${++_instances}`;
    return () => {
